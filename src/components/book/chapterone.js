...
import { textIntro, bgColor, scroll3, scroll4, scroll5 } from '../animate';
...
function ChapterOne() {
  ...
  return (
    ...
    <Jumbotron className="hero text-center" ref={hero} style={{ backgroundImage: `linear-gradient(rgba(101,157,189, 0.3), rgba(101,157,189, 0.3)), url(${process.env.PUBLIC_URL + '/assets/rainbows.jpg'})` }}>
      <div ref={intro}>
        {/* Links to different parts of the Chapter */}
      ...
      {/* Insert urls for carousel pictures in images.js */}
      <div className="wcf">
      ...
      <Row className="mx-auto">
        {/* If you need more videos just add more Col and insert YouTube Video ID into embedId="" */}
